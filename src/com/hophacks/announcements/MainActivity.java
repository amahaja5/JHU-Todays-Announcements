...
public class MainActivity extends TabActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Announce tab
        Intent intentAnnounce = new Intent().setClass(this,
                AnnounceActivity.class);
        TabSpec tabSpecAnnounce = tabHost.newTabSpec("Events")
                .setIndicator("Events").setContent(intentAnnounce);

        // Search tab
        Intent intentSearch = new Intent().setClass(this, SearchActivity.class);
        TabSpec tabSpecSearch = tabHost.newTabSpec("Search")
                .setIndicator("Search").setContent(intentSearch);
