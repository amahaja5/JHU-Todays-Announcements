   ...
   private void generateListView() {
      ...
      my_listview.setOnItemClickListener(new OnItemClickListener() {
      	public void onItemClick(AdapterView<?> parent, View view,
      		...
      		info.setNeutralButton("Remove from Favorites", new DialogInterface.OnClickListener() {
				@Override
				public void onClick(DialogInterface dialog, int which) {
					Toast.makeText(FavoritesActivity.this, "Removed from Favorites!", Toast.LENGTH_LONG).show();					
