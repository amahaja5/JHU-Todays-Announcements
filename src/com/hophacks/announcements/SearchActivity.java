...
public class SearchActivity extends Activity {
    ...
    private static ArrayList<Event> search(
            TreeMap<Date, ArrayList<Event>> tree, String s) {
    ...
    private void generateListView() {
        ...
        if (searched.size() == 0) {
            Toast.makeText(SearchActivity.this, "No search results found.",
        ...
        my_listview.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (!contains(favoriteslist, eventToAdd)) {
                    info.setNeutralButton("Add to Favorites",
